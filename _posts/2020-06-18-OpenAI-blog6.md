...
If you're learning `PyTorch`, **I strongly recommend playing with this notebook in [Google Colab](https://colab.research.google.com/github/katarinaslama/katarinaslama.github.io/blob/master/_posts/2020-06-18-OpenAI-blog6).** When it gives you a warning, select "RUN ANYWAY" (and let that be a life lesson ;-)).
