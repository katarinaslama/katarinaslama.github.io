...
If you're learning `PyTorch`, **I strongly recommend playing with this notebook in [Google Colab](https://colab.research.google.com/github/katarinaslama/katarinaslama.github.io/blob/master/_notebooks/2020-06-18-OpenAI-blog6.ipynb).** When it gives you a warning, select "RUN ANYWAY" (and let that be a life lesson ;-)).
...
[`tqdm`](https://pypi.org/project/tqdm/) is a really cool package that I learned about during the program. It makes a handy progress bar for your network training. The name of the package derives from the Arabic word root ["qadama", to precede](https://cooljugator.com/ar/%D9%82%D8%AF%D9%85), and here it means "progress". So "taqaddum" helps you track your network's progress.
